...
#define PIN_SCL_PTE24 (24U)
#define PIN_SDA_PTE25 (25U)
...
const rtos_i2c_config_t g_rtos_i2c_config = {
		...
		rtos_i2c_portE,	/**Kinetis Port*/
		PIN_SCL_PTE24,	/**Pin of Serial Clock*/
		PIN_SDA_PTE25,	/**Pin of Serial Data*/
		kPORT_MuxAlt5	/**Pin Configuration*/
};
